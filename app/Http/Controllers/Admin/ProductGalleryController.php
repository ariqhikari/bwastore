...
class ProductGalleryController extends Controller
{
    ...
    public function store(ProductGalleryRequest $request)
    {
        ...
        return redirect()->route('product-gallery.index')->with('status', 'Gallery berhasil ditambahkan!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('product-gallery.index')->with('status', 'Gallery berhasil dihapus!');
    }
}
