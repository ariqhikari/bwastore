...
class UserController extends Controller
{
    ...
    public function store(UserRequest $request)
    {
        ...
        $data = $request->all();
        $data['avatar'] = 'assets/profile/avatar-' . $number . '.jpg';
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        $data['avatar'] = $request->file('avatar')->store('assets/profile', 'public');

        if (!Str::contains($item->avatar, 'avatar')) {
        ...
        return redirect()->route('user.index')->with('status', 'User berhasil disunting!');
    }
